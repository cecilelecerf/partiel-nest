...
Application de suivi fitness — monorepo pnpm avec une API NestJS et une interface Next.js.
...
```bash
# Cloner le repo
git clone git@github.com:cecilelecerf/partiel-nest.git
cd partiel-nest
...
| `pnpm lint`    | Lint l'API et le frontend                        |
...
.
└── apps/
    ├── api/          # NestJS — Auth, Users, Exercises, Workouts
...
| Rôle    | Accès                                              |
| ------- | -------------------------------------------------- |
| `USER`  | Ses propres workouts, consultation des exercices   |
| `ADMIN` | CRUD complet sur les exercices et les utilisateurs |
