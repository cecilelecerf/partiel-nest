...
export const WorkoutCard = ({ id, date, _count: { workoutExercice: exerciceCount }, workoutExercice }: WorkoutWithMeta) => {
    const totalDuration = getTotalDuration(workoutExercice)
        ...
        <Link href={`/workouts/${id}`}>
            <CardWrapper>
                <>
                    ...
                    <p>{exerciceCount} exercices - {hour}h{min}</p>
